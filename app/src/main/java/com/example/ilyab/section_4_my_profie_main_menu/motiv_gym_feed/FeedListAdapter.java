...
public class FeedListAdapter extends BaseAdapter {
    ...
    public FeedListAdapter(Activity activity, List<FeedItem> feednews) {
    ...
    @Override
    public int getCount() {
        return feednews.size();
    }

    @Override
    public Object getItem(int location) {
        return feednews.get(location);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.feed_item_gym_feed, null);
        ...
        FeedItem item = feednews.get(position);
